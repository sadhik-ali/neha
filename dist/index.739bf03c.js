...
})({"79pyb":[function(require,module,exports) {
...
var _fakeProgress = require("./fakeProgress");
var _textLinesReveal = require("./textLinesReveal");
var _gsapAnimation = require("./gsapAnimation");
...
const trailImage = new (0, _trail.TrailImage)(document.querySelector(".intro-image"), {
    perspective: 1000,
    totalTrailElements: 8
});
const trailTextTop = new (0, _trail.TrailText)(document.querySelector(".intro-content__title--up"), {
    perspective: 1000,
    totalTrailElements: 2
});
const trailTextBottom = new (0, _trail.TrailText)(document.querySelector(".intro-content__title--down"), {
...
const aboutLines = new (0, _textLinesReveal.TextLinesReveal)(content.aboutText);
// state
let state = {
    isAnimating: false,
    iscontentOpen: false
...
const showIntro = ()=>{
    ...
    (0, _gsap.gsap).timeline({
        defaults: (0, _gsapAnimation.animationDefaults),
        onComplete: ()=>{
        ...
        // Get state
        const state = (0, _flip.Flip).getState(trailImage.DOM.trailElems);
        // Change place
        intro.image.appendChild(trailImage.DOM.el);
        // Flip
        (0, _flip.Flip).from(state, {
            duration: (0, _gsapAnimation.animationDefaults).duration,
            ease: (0, _gsapAnimation.animationDefaults).ease,
            stagger: -0.03,
            scale: true
        });
    ...
    .to(trailTextTop.DOM.trailElems, {
        ...
        opacity: 1,
        stagger: -0.1
    }, "start").to(trailTextBottom.DOM.trailElems, {
        y: 0,
        opacity: 1,
        stagger: -0.08
...
const showContent = ()=>{
    if (state.isAnimating || state.iscontentOpen) return false;
    state.isAnimating = true;
    ...
    }).addLabel("start", 0).to(intro.enterButton, {
        duration: 0.6,
        opacity: 0,
        scale: 0.8
    }, "start").add(()=>{
        const topTitleState = (0, _flip.Flip).getState(trailTextTop.DOM.el);
        const bottomTitleState = (0, _flip.Flip).getState(trailTextBottom.DOM.el);
        content.titleTop.appendChild(trailTextTop.DOM.el);
        content.titleBottom.appendChild(trailTextBottom.DOM.el);
        (0, _flip.Flip).from(topTitleState, {
            duration: (0, _gsapAnimation.animationDefaults).duration,
            ease: (0, _gsapAnimation.animationDefaults).ease,
            scale: true
        });
        (0, _flip.Flip).from(bottomTitleState, {
            duration: (0, _gsapAnimation.animationDefaults).duration,
            ease: (0, _gsapAnimation.animationDefaults).ease,
            scale: true
        });
        const imageState = (0, _flip.Flip).getState(trailImage.DOM.el, {
            props: "border-radius"
        });
        // Change place
        content.finalImagePlacement.appendChild(trailImage.DOM.el);
        (0, _gsap.gsap).set(trailImage.DOM.el, {
            opacity: 1
        });
        // Flip
        (0, _flip.Flip).from(imageState, {
            duration: (0, _gsapAnimation.animationDefaults).duration,
            ease: (0, _gsapAnimation.animationDefaults).ease
        });
...
const fakeProgress = new (0, _fakeProgress.FakeProgress)(frame.progress);
fakeProgress.onComplete(showIntro);
// Preload images
(0, _utils.preloadImages)(".intro-image").then((_)=>document.body.classList.remove("loading"));

},{"./utils":"72Dku","./trail":"bzOvk","./fakeProgress":"liM6z","./textLinesReveal":"2JTlA","./gsapAnimation":"8FhUl","gsap":"fPSuC","gsap/Flip":"iKp6p"}],"72Dku":[function(require,module,exports) {
...
},{}],"bzOvk":[function(require,module,exports) {
/**
 ...
 */ parcelHelpers.export(exports, "TrailImage", ()=>TrailImage);
/**
 * Class representing a text trail element
 */ parcelHelpers.export(exports, "TrailText", ()=>TrailText);
class Trail {
    // DOM elements
    DOM = {
        // Main element (.trail)
...
class TrailImage extends Trail {
    // the image path
    bgImage;
    /**
	 * Constructor.
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"liM6z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
 * Class representing a fake progress loader
 */ parcelHelpers.export(exports, "FakeProgress", ()=>FakeProgress);
var _gsap = require("gsap");
class FakeProgress {
    // DOM elements
    DOM = {
	 ...
	 */ onComplete(onProgressComplete) {
        return (0, _gsap.gsap).timeline().to(this.progressVal, {
            duration: 1.5,
            ease: "steps(14)",
            value: 100,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2JTlA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"split-type":"fvGAG","./gsapAnimation":"8FhUl","./utils":"72Dku","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fvGAG":[function(require,module,exports) {
/**
 * SplitType
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8FhUl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "animationDefaults", ()=>animationDefaults);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["79pyb","ebWYT"], "ebWYT", "parcelRequire23b3")
